...
- CIC top-1 repair accuracy: `0.719`
- CIC top-3 repair accuracy: `0.281`
- CIC clean-safe repair accuracy: `0.719`
- Matched random candidate-region accuracy: `0.172`
- CIC top-1 minus matched random (gap): `0.547`
- Clean-safe clean drop: `0.000`
- (Diagnostic) top-1 candidate IoU with oracle decoy region: `0.427`
- Validation-selected clean-safe score threshold: `0.189`
